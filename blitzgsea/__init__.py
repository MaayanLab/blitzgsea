...
def gsea(signature, library, permutations: int=2000, anchors: int=16, min_size: int=5, max_size: int=np.inf, processes: int=4, plotting: bool=False, verbose: bool=False, symmetric: bool=True, signature_cache: bool=True, seed: int=0):
    if seed == -1:
